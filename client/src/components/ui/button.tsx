...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, onClick, ...props }, ref) => {
    ...
    // Handle touch and click events for better mobile experience
    const handleInteraction = React.useCallback((event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    return (
      <Comp
        ...
        style={{
          // Ensure touch target size meets accessibility guidelines
          minHeight: '44px',
          minWidth: '44px',
          // Disable touch callout and text selection for better UX
